...
import br.exemplocontentprovider.domain.AlunosContract;
...
public class AlunosProvider extends ContentProvider {
	...
	static {
		...
		// content://br.exemplocontentprovider.aluno.provider/alunos
		uriAlunos.addURI(AlunosContract.AUTHORITY, "alunos/", AlunosContract.ALUNOS);
		
		// content://br.exemplocontentprovider.aluno.provider/alunos/2
	...
	public String getType(Uri uri) {
		switch(uriAlunos.match(uri)){
			...
			default:
				throw new IllegalArgumentException("Uri inv�lida: "+uri);
		}
	}
